...
public class EntityGenerator {
    ...
    public void entityGenerator() {
        ...
        gc.setOutputDir("D:\\demo\\guns\\guns-cinema\\src\\main\\java");//这里写你自己的java目录
        ...
        strategy.setInclude(new String[]{"mooc_brand_dict_t", "mooc_area_dict_t",
                            "mooc_hall_dict_t", "mooc_cinema_t", "mooc_field_t", "mooc_hall_film_info_t"});  //设置生成的表名
